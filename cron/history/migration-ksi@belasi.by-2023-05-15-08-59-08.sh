#!/bin/bash
mv ~/Documents/imapsync/cron/migration-ksi@belasi.by-2023-05-15-08-59-08.sh ~/Documents/imapsync/cron/history/migration-ksi@belasi.by-2023-05-15-08-59-08.sh
cd `dirname $0`
