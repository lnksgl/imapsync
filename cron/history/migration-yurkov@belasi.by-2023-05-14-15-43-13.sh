#!/bin/bash
mv ~/Documents/imapsync/cron/migration-yurkov@belasi.by-2023-05-14-15-43-13.sh ~/Documents/imapsync/cron/history/migration-yurkov@belasi.by-2023-05-14-15-43-13.sh
cd `dirname $0`
