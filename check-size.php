<?php    
    ...
    if($_POST['submit']) {
		...
		." --ssl1 --host2 ".$msrv2
		." --user2 ".$mail2
		." --password2 ".$pass2." --ssl2 --justfoldersizes | tee /var/www/html/cron/LOG_imapsync/".$name.".txt\n");	
    ...
    $command = 'python3 /var/www/html/check-size.py '.$mail1.' '.$mail2.' '.$name;
    exec($command);
?>
